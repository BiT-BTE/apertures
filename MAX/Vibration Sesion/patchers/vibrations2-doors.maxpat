...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1066.0, 267.0, 87.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 919.0, 263.0, 87.0, 22.0 ],
					"presentation_linecount" : 2,
					"text" : "/MB 0.25 -0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 905.0, 150.0, 200.0, 20.0 ],
					"text" : "Cerrar"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1070.0, 150.0, 200.0, 20.0 ],
					"text" : "Abrir"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1070.0, 233.0, 55.0, 22.0 ],
					"text" : "/M2 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 924.0, 228.0, 59.0, 22.0 ],
					"presentation_linecount" : 2,
					"text" : "/M2 -0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1070.0, 186.0, 59.0, 22.0 ],
					"presentation_linecount" : 2,
					"text" : "/M1 -0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 924.0, 181.0, 55.0, 22.0 ],
					"text" : "/M1 0.25"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1071.0, 301.0, 74.0, 22.0 ],
					"text" : "/MB -0.5 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 924.0, 297.0, 74.0, 22.0 ],
					"text" : "/MB 0.5 -0.5"
				}
